...
const ExpenseWithId = object().shape({
...
function addExpenseSchema() {
    return UserIdMonthYearCategoriaValorRequired
}

function deleteExpenseSchema() {
    return IdRequired
}
...
export { getByMonthSchema, addExpenseSchema, getTotalGroupedByDateSchema, deleteExpenseSchema, updateExpenseSchema }